...
import eu.inqudium.limesium.servlet.logging.RequestLoggingFilter;
...
/**
 * Exercises the shaded servlet jar from the consumer's side of the Shade boundary (ADR-0003): the
...
class ShadedTwinSmokeTest {
    ...
    void should_carry_the_shared_classes_in_the_twin_jar_and_nowhere_else() throws IOException {
        ...
        assertThat(jars.get(0)).contains("limesium-servlet-logging").doesNotContain("limesium-common");
    }
    ...
    void should_auto_configure_the_twin_from_the_shaded_jar() {
        ...
        // Given/When/Then
        assertThat(context.getBeansOfType(RequestLoggingFilter.class)).hasSize(1);
    }
