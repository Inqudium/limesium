...
private class OwnFilterHostConfig {
    @Bean
    fun hostRequestLoggingFilter(properties: RequestLoggingProperties): RequestLoggingFilter =
        RequestLoggingFilter(properties, NanoTimeSource.SYSTEM, CorrelationIdGenerator.RANDOM_UUID, SimpleMeterRegistry())
}
